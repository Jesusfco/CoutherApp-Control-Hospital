...
<body>
    ...
    <p><strong>Antecedentes Heredofamiliares:</strong>{!! nl2br($obj->heredofamiliares) !!} </p>    
    <p><strong>Antecedentes Persnolaes No Patológicos:</strong>{!! nl2br($obj->personales_no_patologicos) !!} </p>    
    <p><strong>Antecedentes Persnolaes Patológicos:</strong>{!! nl2br($obj->personales_patologicos) !!} </p>    
    <h5>Interrogacón Por Aparatos y Sistemas</h5>
    <p><strong>Síntomas generales:</strong>{!! nl2br($obj->sintomas_generales) !!} </p>    
    <p><strong>Respiratorio:</strong>{!! nl2br($obj->respiratorio) !!} </p>    
    <p><strong>Cardiovascular:</strong>{!! nl2br($obj->cardiovascular) !!} </p>    
    <p><strong>Digestivo:</strong>{!! nl2br($obj->digestivo) !!} </p>    
    <p><strong>Urinario:</strong>{!! nl2br($obj->urinario) !!} </p>    
    <p><strong>Reproductor:</strong>{!! nl2br($obj->reproductor) !!} </p>    
    <p><strong>Hemolinfático:</strong>{!! nl2br($obj->hemolinfatico) !!} </p>    
    <p><strong>Endocrino:</strong>{!! nl2br($obj->endocrino) !!} </p>    
    <p><strong>Sistema Nervioso:</strong>{!! nl2br($obj->sistema_nervioso) !!} </p>    
    <p><strong>Musculo-Esquelético:</strong>{!! nl2br($obj->musculo_esqueletico) !!} </p>    
    <p><strong>Piel y Anexos:</strong>{!! nl2br($obj->piel_anexos) !!} </p>    
    ...
    <p><strong>Habitus Exterior:</strong> {!! nl2br($obj->habitus_exterior) !!} </p>    
    <p><strong>Cabeza:</strong> {!! nl2br($obj->cabeza) !!} </p>    
    <p><strong>Cuello:</strong> {!! nl2br($obj->cuello) !!} </p>    
    <p><strong>Tórax:</strong> {!! nl2br($obj->torax) !!} </p>    
    <p><strong>Abdomen:</strong> {!! nl2br($obj->abdomen) !!} </p>    
    <p><strong>Genitales:</strong> {!! nl2br($obj->genitales) !!} </p> 
    <p><strong>Exploración Ginecologica:</strong> {!! nl2br($obj->exploracion_ginecologica) !!} </p>    
    <p><strong>Columna Vertebral:</strong> {!! nl2br($obj->columna_vertebral) !!} </p>    
    <p><strong>Extremidades Superiores e Inferiores:</strong> {!! nl2br($obj->extremidades) !!} </p>    
    <p><strong>Exploración Neurologica:</strong> {!! nl2br($obj->exploracion_neurologica) !!} </p>            
     
    <p><strong>IV. DIAGNOSTICO:</strong></p>        
    <p style="text-align: center">DIAGNOSTICO</p>
    <p>{!! nl2br($obj->diagnostico) !!} </p>        
    <p><strong>PLAN A SEGUIR:</strong>{!! nl2br($obj->plan) !!} </p>    
