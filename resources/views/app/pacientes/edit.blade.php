...
<h5><a href="{{ url('app/pacientes') }}">Pacientes </a> / Editar Paciente</h5>
<div>
  <a class="btn blue" href="{{ url('app/pacientes/ver', $obj->id) }}">Ver Paciente</a>
</div>
...
<form class="row" role="form" method="POST" enctype="multipart/form-data" onsubmit="return submitForm()">
    ...
    <input type="hidden" name="user_type" value="{{$obj->user_type}}">

    <div class="form-group col l6">
      <label for="exampleInputEmail1">Nombre</label>
      <input type="text" name="name" class="form-control" value="{{ $obj->name }}"  placeholder="Nombre" required autofocus>
    </div>
    <div class="form-group col l6">
