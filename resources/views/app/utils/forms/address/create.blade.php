<div class="form-group col l6">
    ...
    <input type="text" name="calle" class="form-control" value="{{ old('calle') }}" onkeypress="return onlyAlphabeticCharacterKey(event)" maxlength="30">
</div>    
<div class="form-group col l6">
...
<div class="form-group col l4">
    ...
    <input type="text" name="cp" class="form-control" value="{{ old('cp') }}" onkeypress="return onlyNumberIntegersKey(event)" maxlength="5">
</div>
<div class="form-group col l4">
    <label for="exampleInputEmail1">Ciudad</label>
    <input type="text" name="ciudad" class="form-control" value="{{ old('ciudad') }}" maxlength="20" onkeypress="return onlyAlphabeticCharacterKey(event)">
</div>
<div class="form-group col l4">
