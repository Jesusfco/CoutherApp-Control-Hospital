...
<form class="row" role="form" method="POST" enctype="multipart/form-data" onsubmit="return submitForm()" id="form2" action="{{url('app/antecedentes')}}">
    ...
    <div class=" col l4">
      ...
      <input  value="{{ Auth::user()->nombre_completo }}" disabled id="medico" class="validate">
    </div>
    <div class=" col l4">
      <label for="exampleInputEmail1">Cédula</label>
      <input  value="{{ Auth::user()->cedula }}" disabled>
    </div>  
      ...
      <table class="striped responsive-table">
        ...
        <tbody>
          <tr>
            ...
            <td><input onkeyup="requiredAfterSomeOnInput(event)" onkeypress="return onlyNumberKey(event)" type="number" step="0.1" min=".1" max="99" name="frecuencia_cardiaca" value="{{ old('frecuencia_cardiaca') }}"></td>
          </tr>
        </tbody>
      </table>
    </div>
