...
<form class="row" id="form2" role="form" method="POST" enctype="multipart/form-data" onsubmit="return appForm.submit(event)">
    ...
    <div class="input-field col l6">
      <input type="password" v-model="password" name="password" class="form-control" minlength="8" maxlength="16" :required="password.length > 0" onkeyup="return syncPasswordValidation(event)">
